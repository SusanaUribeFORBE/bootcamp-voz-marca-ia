# Guión de Demo (3-5 min) — Voz de Marca IA
...
identidad clara: una sazón, una historia, una forma de hablarle a su gente.
El problema no es falta de ideas — es falta de tiempo para convertir esa
identidad en contenido consistente, semana tras semana, en varios canales a
la vez.
...
2. **Ideas**: generar un lote de ideas nuevas en vivo. Señalar arriba de la
   ...
   transparente, no una caja negra). Al abrir cada idea, mostrar el badge
...
> Frijolitos que llevan horas al fuego, chicharrón que suena desde lejos y
> una sazón que no se aprende, se hereda 👵🔥
> Así nace, frente a sus ojos, la bandeja paisa de Doña Pola: sin atajos, sin
> afán, como debe ser.
> La cocina a la vista pa' que vea que aquí no se esconde nada, parcero.
>
> 👉 Venga y véala nacer usted mismo, lo esperamos con mesa y cuchara lista.
>
> #FondaDoñaPola #Laureles #Medellín #ComidaAntioqueña #SazónPaisa
> #BandejaPaisa

### WhatsApp

> ¡Quiubo, parcero! 👋
> Hoy grabamos cómo nace su bandeja paisa desde la cocina, a la vista de
> todos: sin atajos, con la sazón de Doña Pola de toda la vida.
> ¿Le guardamos mesa para que la vea (y se la coma) en vivo?
> Responda este mensaje y le decimos disponibilidad.

### Blog (extracto)

> # Así nace su bandeja paisa frente a sus ojos
>
> Hay platos que se piden y platos que se viven. En Fonda Doña Pola, la
> bandeja paisa es de las segundas: se prepara a la vista de todos, sin
> cortinas ni carreras, tal como la hacía Doña Pola en su cocina de Oriente
> antioqueño hace más de cuarenta años.
>
> ## Una cocina sin secretos (bueno, casi ninguno)
>
> Nuestra cocina abierta no es un capricho de decoración. Es una manera de
> decirle a usted, que viene a comer, que aquí no hay atajos [...]
>
> *(artículo completo de ~500 palabras, con las secciones "Lo que la plaza
> traiga, eso se cocina", "Compartir en mesa, como debe ser" y "Véngase a ver
> cómo se hace")*

**Lo que hay que señalar en la demo**: el ángulo, el tono cálido con humor
paisa, y los valores (cocina a la vista, sazón heredada, ingredientes
frescos de la plaza) son los mismos en los tres textos — solo cambia el
formato: Instagram es corto y con hashtags, WhatsApp es una invitación
...
- **El perfil de marca se define una vez y se reutiliza en cada llamada**:
  ...
  vez que se pide contenido nuevo — la app lo inyecta automáticamente en
  cada generación, así que la voz nunca varía entre una idea y la siguiente.
- **El calendario resuelve solo las reglas de frecuencia por canal**: usted
...
Laureles y a la plaza de mercado del Oriente antioqueño), y esas señales se
reflejan en cada pieza generada. El resultado no suena a plantilla de
marketing traducida: suena a una fonda de barrio en Medellín, con su propio
acento y su propia forma de invitar a la gente a la mesa. Ese nivel de
